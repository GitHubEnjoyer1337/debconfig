...
apt install sudo xorg wget curl tmux build-essential dos2unix exfat-fuse \
exfatprogs ntfs-3g alsa-utils pulseaudio pavucontrol net-tools nmap feh \
gdisk gimp maim slop xclip ripgrep zathura vim vim-gtk3 sddm i3 golang \
exiftool lshw rsync libreoffice redshift e2fsprogs zsh pkg-config acl \
